...
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 126 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(0, [C|Ics], Line, Tlen, Action, Alen) when C >= 128 ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
...
-file("src/myscan.xrl", 2).
yyaction_0(TokenChars, TokenLine) ->
     { token, { interger, TokenLine, TokenChars } } .
